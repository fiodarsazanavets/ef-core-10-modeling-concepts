...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(b =>
        {
            ...
            b.ComplexProperty(c => c.Preferences, p => p.ToJson());

            // Optional “computed indexable projection” for older SQL Server:
            // (Lets you index JSON_VALUE without scanning JSON every time)
            b.Property<string>("PreferencesTheme")
             .HasComputedColumnSql("JSON_VALUE([Preferences], '$.Ui.Theme')", stored: true);
        ...
        modelBuilder.Entity<Order>(b =>
        {
            ...
            b.ComplexProperty(o => o.Audit, a => a.ToJson());
        });
        ...
        modelBuilder.Entity<Product>(b =>
        {
            ...
            b.ComplexProperty(p => p.Catalog, c => c.ToJson());
        });
    ...
    private static void ConfigureProductHierarchy(ModelBuilder modelBuilder)
    {
